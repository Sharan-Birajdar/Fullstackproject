...
DOCKER_IMAGE_NAME="sharanbirajdar/vault-backend"
...
HOST_PORT=8000
CONTAINER_PORT=8000
ENV_FILE="C:\Users\ADMIN\Downloads\fullstack-auth\fullstack-auth\backend\.env"                       # ← Path to your existing .env file
# ──────────────────────────────────────────────────────────
